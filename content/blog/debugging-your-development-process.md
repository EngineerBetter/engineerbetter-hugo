...
> The EngineerBetter team worked with us for a couple of days as we were planning to scale up from a single development site to having two. They provided us with an incredibly valuable external perspective that have helped us articulate and prioritise improvements to our engineering culture. <br /><br />One recommendation was that we adopt a "remote by default" approach. This gave us a different way to think about what we were already doing and was readily embraced by our development team. When we found that we needed to embrace working remotely for everyone, we were much better prepared to make that happen. We look forward to working with them in the future.
