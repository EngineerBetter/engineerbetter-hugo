...
These don't just apply at one level - rather, these principles are like a [stick of rock](https://en.wikipedia.org/wiki/Rock_(confectionery)) in that they run vertically throughout an organisation, applying at scales from the individual user story to corporate strategy.
...
* Proper discovery activities _before_ starting a programme of work
* Stories that explain why an activity needs to be done
...
* Mechanisms to measure and track metrics that will determine the success of hypotheses
