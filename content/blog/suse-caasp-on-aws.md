...
The SUSE Containers as a Service (CaaS) Platform deployment on AWS recently went into technological preview (as of [version 4.1.2](https://www.suse.com/releasenotes/x86_64/SUSE-CAASP/4/#_deployment_on_aws_as_technology_preview)). I spent a few days going through the docs and deploying my own SUSE CaaSP cluster on AWS, and here are my tips for a smooth deployment.
